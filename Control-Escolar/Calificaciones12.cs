    ...
    public partial class Calificaciones12 : MaterialForm
    {
        ...
        private void materialRaisedButton2_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(sesion.grado) == 1)
            {
                ...
                Process.Start(@"c:\shashe\BoletaExterna1.pdf");
            }
            else
            {
                if (Convert.ToInt32(sesion.grado) == 2)
                {
                    ...
                    MessageBox.Show("¡PDF creado!");
                    Process.Start(@"c:\shashe\BoletaExterna2.pdf");
                }
                else
                {
        ...
        private void btnIrBoletas_Click_1(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("¡PDF creado!");
            Process.Start(@"c:\shashe\Boleta-Interna12.pdf");
        ...
        private void Calificaciones12_FormClosing(object sender, FormClosingEventArgs e)
        {
