...
namespace Control_Escolar
{
    public partial class CadaGrupo : MaterialForm
    {
        ...
        public static void ThreadListasCalf()

        {
            Application.Run(new ListaDeCalificacionesGrupos());
        }
        //-----------------------------------------Botones--------------------------------------------
        //Cerrar sesion
        ...
        private void GenerarPDF_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(sesion.Grado) == 1)
            {
                ...
                // Creamos el documento con el tamaño de página tradicional
                FileStream stream = new FileStream(folderPath + "Lista-Asistencia1.pdf", FileMode.Create);
                ...
                Process.Start(@"c:\shashe\Lista-Asistencia1.pdf");
            }
            else
            {
                if (Convert.ToInt32(sesion.Grado) == 2)
                {
                    ...
                    MessageBox.Show("¡PDF creado!");
                    Process.Start(@"c:\shashe\Lista-Asistencia2.pdf");
                }
                else
                {
                    if (Convert.ToInt32(sesion.Grado) == 3)
                    {
                        ...
                        MessageBox.Show("¡PDF creado!");
                        Process.Start(@"c:\shashe\Lista-Asistencia3.pdf");
                    }
                    else
                    {
                        if (Convert.ToInt32(sesion.Grado) == 4)
                        {
                            ...
                            MessageBox.Show("¡PDF creado!");
                            Process.Start(@"c:\shashe\Lista-Asistencia4.pdf");
                        }
                        else
                        {
                            if (Convert.ToInt32(sesion.Grado) == 5)
                            {
                                ...
                                MessageBox.Show("¡PDF creado!");
                                Process.Start(@"c:\shashe\Lista-Asistencia5.pdf");
                            }
                            else
                            {
                                if (Convert.ToInt32(sesion.Grado) == 6)
                                {
                                    ...
                                    MessageBox.Show("¡PDF creado!");
                                    Process.Start(@"c:\shashe\Lista-Asistencia6.pdf");
                                }
                                else
                                {
        ...
        private void CadaGrupo_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            System.Threading.Thread pantalla = new System.Threading.Thread(new System.Threading.ThreadStart(ThreadListasCalf));
            pantalla.Start();
            CheckForIllegalCrossThreadCalls = false;
            this.Close();
        }
